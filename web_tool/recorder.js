    ...
    async start() {
        try {
            ...
            this.mediaRecorder.addEventListener("dataavailable", (event) => {
                // Push chunk for streaming mode as well
            ...
            // Request data every 500ms for low-latency streaming
...
// Hook for streaming chunk callback (set externally)
AudioRecorder.prototype.onChunk = null;